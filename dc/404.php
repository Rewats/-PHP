...
<div class="error">
  ...
  <div class="error__subtitle">Sayfa Bulunamadı</div>
  <div class="error__description">Hacı sen çok yanlış geldin ya</div>

  <a href="main.php"><button class="error__button"  >GERİ DÖN</button></a>
</div>
